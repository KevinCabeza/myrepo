...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f0c5d9e5b38>'

__spec__ = None # (!) real value is "ModuleSpec(name='readline', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f0c5d9e5b38>, origin='/usr/lib/python3.6/lib-dynload/readline.cpython-36m-x86_64-linux-gnu.so')"
