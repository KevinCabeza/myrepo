...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff32ffa2b70>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lsprof', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff32ffa2b70>, origin='/usr/lib/python3.6/lib-dynload/_lsprof.cpython-36m-x86_64-linux-gnu.so')"
