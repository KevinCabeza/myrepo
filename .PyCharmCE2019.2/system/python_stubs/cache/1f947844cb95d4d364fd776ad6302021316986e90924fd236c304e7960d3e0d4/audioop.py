...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7abe358b70>'

__spec__ = None # (!) real value is "ModuleSpec(name='audioop', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7abe358b70>, origin='/usr/lib/python3.6/lib-dynload/audioop.cpython-36m-x86_64-linux-gnu.so')"
